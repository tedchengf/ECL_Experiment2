...
def starter_win(win, disp_objs = []):
	...
	msg1 = visual.TextBox2(win,"The corporation has also uncovered three kinds of alien machines: alpha, beta, and gamma (machine gamma is shown above). While alpha and beta have one slot, gamma has two. When correct artifacts are inserted, these machines will emit light, produce heat, and trigger explosions respectively.", pos = (0,-14), size = [40, None], alignment = 'left', letterHeight = 0.8)
	M_GAMMA_S = visual.ImageStim(win, "rsc/2O3F2D/gamma_s.png")
	M_GAMMA_S.pos = (0, 7)
