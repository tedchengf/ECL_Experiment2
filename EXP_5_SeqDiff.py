...
def main():
	...
	OBJ_B_DICT1 = {
		...
		3: visual.ImageStim(WIN, "rsc/2O3F2D/pxg.png"),
		5: visual.ImageStim(WIN, "rsc/2O3F2D/ppl.png"),
		7: visual.ImageStim(WIN, "rsc/2O3F2D/ppg.png"),
		11: visual.ImageStim(WIN, "rsc/2O3F2D/yxl.png"),
		13: visual.ImageStim(WIN, "rsc/2O3F2D/yxg.png"),
		17: visual.ImageStim(WIN, "rsc/2O3F2D/ypl.png"),
		19: visual.ImageStim(WIN, "rsc/2O3F2D/ypg.png"),
	}
	OBJ_B_DICT2 = {
		2: visual.ImageStim(WIN, "rsc/2O3F2D/pxl.png"),
		3: visual.ImageStim(WIN, "rsc/2O3F2D/pxg.png"),
	...
	OBJ_B_DICTS = [OBJ_B_DICT1, OBJ_B_DICT2, OBJ_B_DICT3]
	# DICT C: The Fishscale-Octagon Dict
	OBJ_C_DICT1 = {
		2: visual.ImageStim(WIN, "rsc/2O3F2D/gfa.png"),
		3: visual.ImageStim(WIN, "rsc/2O3F2D/gfs.png"),
		5: visual.ImageStim(WIN, "rsc/2O3F2D/goa.png"),
		7: visual.ImageStim(WIN, "rsc/2O3F2D/gos.png"),
		11: visual.ImageStim(WIN, "rsc/2O3F2D/rfa.png"),
		13: visual.ImageStim(WIN, "rsc/2O3F2D/rfs.png"),
		17: visual.ImageStim(WIN, "rsc/2O3F2D/roa.png"),
		19: visual.ImageStim(WIN, "rsc/2O3F2D/ros.png"),
	}
	OBJ_C_DICT2 = {
		2: visual.ImageStim(WIN, "rsc/2O3F2D/gfa.png"),
		3: visual.ImageStim(WIN, "rsc/2O3F2D/gfs.png"),
	...
	TRIAL_OBJ_DICT_B = {
		...
		"Correct_sound": sound.Sound("rsc/Correct.wav"),
		"Incorrect_sound": sound.Sound("rsc/Incorrect.wav"),
		"Correct_text": visual.TextBox2(WIN, "Congrats! You prediction is correct!", pos = [0, -15], alignment = 'center', color = "Green", letterHeight = 0.8),
	...
	if conj_seq == "PW":
		...
		block_disp_start = visual.TextBox2(WIN, "Let's start with the first experimental block. In this block, you will go through 20 trials where a single artifact is probed for light emission. You should try your best to learn the rule behind this reaction.", alignment = 'left', letterHeight = 0.8)
		test_disp_start = visual.TextBox2(WIN, "Now that you have gone through 20 trials, you probably have some ideas about the objects that triggers light emission. To demonstrate your knowledge, you will go through 8 test trials and provide your predictions again; except that this time no feedback will be provided.", alignment = 'left', pos = (0, 5), size = [40, None],  letterHeight = 0.8)
	elif conj_seq == "DW":
	...
	block_obj_start = visual.TextBox2(WIN, "Above are the 8 objects that will be investigated in this block. They differ in their sizes, shapes, and textures; their orders and positions play no role whatsoever.", pos = (0,-14), size = [40, None], alignment = 'left', letterHeight = 0.8)
	block_seq = correct_seq + incorrect_seq
	random.shuffle(block_seq)
...
def show_all_objs(win, objects, message, disp_objs):
	objects[0].pos = (18, 12)
	objects[1].pos = (6, 12)
	objects[2].pos = (-6, 12)
	objects[3].pos = (-18, 12)
	...
	objects[6].pos = (-6, -3)
	objects[7].pos = (-18, -3)
	for onj in [message] + objects + disp_objs:
		print(onj)

	spec_cont(win, ABORT_KEY, PROCEED_KEYS, [message] + objects + disp_objs)	
	return
