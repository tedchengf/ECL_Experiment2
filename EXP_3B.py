...
def main():
	...
	random.shuffle(block_seq)
	block_disp_start = visual.TextBox2(WIN, "You are now ready to go through the test block. You will only go through 10 combinations this time, and no feedback will be provided.", alignment = 'left', pos = (0, 5), size = [40, None],  letterHeight = 0.8)
...
def starter_win(win, disp_objs = []):
	...
	msg1 = visual.TextBox2(win,"After going through two training blocks, you will encounter the test block. The structure of the test block will be identitical to that of the training blocks, except that you only need to go through 10 combinations and will no longer receive feedback from your choices. The corporate will take your choices in the test block as your report of the experiment.", pos = (0,1), size = [40, None], alignment = 'left', letterHeight = 0.8)
	spec_cont(win, ABORT_KEY, PROCEED_KEYS, [msg1] + disp_objs)
	core.wait(0.2)
